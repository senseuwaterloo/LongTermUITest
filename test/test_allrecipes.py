...
class TestAllrecipes:
    def test_allrecipes_87db8a52(self):
        ...
        self.driver.find_element(By.ID, "mntl-search-form--open__search-input").click()
        self.driver.find_element(By.ID, "mntl-search-form--open__search-input").clear()
        self.driver.find_element(By.ID, "mntl-search-form--open__search-input").send_keys("cinnamon")
