...
class TestCarnival:
    ...
    def test_carnival_c1b8361d(self):
        ...
        self.driver.find_element(By.XPATH, "//div[@id='ccl-cruise-search']/ccl-cruise-search[1]/div[3]/ccl-cruise-search-bar[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/ul[2]/li[11]/button[1]").click()
