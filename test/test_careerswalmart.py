...
class TestCareersWalmart:
    ...
    def test_careerswalmart_051a421d(self):
        ...
        time.sleep(1) # selenium.common.exceptions.StaleElementReferenceException: Message: stale element reference: stale element not found in the current frame
        ...
        # //ul[@id="search-results"]/li/div[1]/h4/a
        time.sleep(1)  # selenium.common.exceptions.StaleElementReferenceException: Message: stale element reference: stale element not found in the current frame
