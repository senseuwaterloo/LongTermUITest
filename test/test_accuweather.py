...
class TestAccuweather:
    ...
    #     # self.driver.get("https://www.accuweather.com/")
    #     self.driver.find_element(By.XPATH, "//input[@name='query' and @type='text' and @placeholder='Search your Address, City or Zip Code']").clear()
    #     self.driver.find_element(By.XPATH, "//input[@name='query' and @type='text' and @placeholder='Search your Address, City or Zip Code']").send_keys("Maine North, Ireland")
    #     self.driver.find_element(By.XPATH, "/html/body[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]").click()
    #     self.driver.find_element(By.CSS_SELECTOR, "body > div > div.page-hero.hero-1.content-module.has-alerts > div.basic-header.has-alerts.is-hero.is-at-top > div.header-outer > div > div > svg.hamburger-button.icon-hamburger").click()
    #     self.driver.find_element(By.XPATH, "//a[contains(text(),'Air Quality')]").click()
    #     self.driver.find_element(By.XPATH, "//h1[contains(.,'Maine, NC')]").click()
    #     self.driver.find_element(By.XPATH, "/html/body[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]").click()
    #     self.driver.find_element(By.XPATH, "//span[contains(.,'Location')]").click()
    #     self.driver.find_element(By.XPATH, "//input[@name='query' and @type='text' and @placeholder='Search your Address, City or Zip Code']").clear()
    #     self.driver.find_element(By.XPATH, "//input[@name='query' and @type='text' and @placeholder='Search your Address, City or Zip Code']").send_keys("Maine Nortyh Ireland")
    #     self.driver.find_element(By.XPATH, "//input[@name='query' and @type='text' and @placeholder='Search your Address, City or Zip Code']").clear()
    #     self.driver.find_element(By.XPATH, "//input[@name='query' and @type='text' and @placeholder='Search your Address, City or Zip Code']").send_keys("Maine North, County Cork, Ireland")
    #     self.driver.find_element(By.XPATH, "//input[@name='query' and @type='text' and @placeholder='Search your Address, City or Zip Code']").click()
    #     self.driver.find_element(By.XPATH, "//input[@name='query' and @type='text' and @placeholder='Search your Address, City or Zip Code']").clear()
    #     self.driver.find_element(By.XPATH, "//input[@name='query' and @type='text' and @placeholder='Search your Address, City or Zip Code']").send_keys("maine north")
